        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="pa_content", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
                (
                    "portlet_type",
                    models.ForeignKey(
                        related_name="pa_portlets", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.ForeignKey(
                        related_name="pb_content", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
            ],
        ),
